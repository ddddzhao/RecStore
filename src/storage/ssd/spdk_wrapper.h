...
public:
  ...
  virtual void SubmitReadCommand(
      void* pinned_dst,
      const int64_t bytes,
      const int64_t lba,
  ...
  virtual int SubmitWriteCommand(
  ...
  virtual void SyncRead(
      void* pinned_dst, const int64_t bytes, const int64_t lba, int qp_id) = 0;

  virtual void SyncWrite(const void* pinned_src,
                         const int64_t bytes,
                         const int64_t lba,
                         int qp_id) = 0;
